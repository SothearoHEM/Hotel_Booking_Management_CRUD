...
<div>
    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
        ...
        <form action="{{ route('bookings.store') }}" method="POST" id="bookingForm">
            ...
            <div class="mb-4 p-4 bg-gray-50 rounded-lg" id="costPreview" style="display: none;">
                <div class="flex justify-between items-center">
                    <div>
                        <p class="text-sm text-gray-600">Nights: <span id="nightsCount">0</span></p>
                        <p class="text-sm text-gray-600">Price per night: $<span id="pricePerNight">0.00</span></p>
                    </div>
                    <div class="text-right">
                        <p class="text-sm text-gray-600">Total Cost</p>
                        <p class="text-2xl font-bold text-gray-900" id="totalCost">$0.00</p>
                    </div>
                </div>
            </div>
